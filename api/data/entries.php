...
return [
    ...
    [
        ...
        'title' => '¿Y si una economía no se midiera solamente por la plata?',
        'theme' => 'Economía del Bien Común',
        'blocks' => [
            ['type' => 'heading', 'text' => "Una forma diferente de ver qué significa que una economía funcione bien"],
            ['type' => 'paragraph', 'text' => "La verdad, este tema me pareció bastante interesante porque siento que normalmente cuando uno piensa en economía, lo primero que se le viene a la cabeza es plata, crecimiento, empresas y cuánto se está produciendo. Pero con la Economía del Bien Común empecé a ver que también se puede preguntar qué tanto una actividad económica está ayudando realmente a las personas y a la sociedad."],
            ['type' => 'paragraph', 'text' => "Lo que entendí es que este modelo no dice simplemente que ganar dinero esté mal, sino que plantea que eso no debería ser la única medida para saber si una empresa está haciendo las cosas bien. También importan cosas como la dignidad de las personas, la solidaridad, la justicia social, el ambiente y la forma en que se toman las decisiones."],
            ['type' => 'highlight', 'text' => "Ganar plata puede decir cuánto funciona una empresa económicamente, pero no necesariamente dice qué impacto está teniendo."],
            ['type' => 'heading', 'text' => "Ahí fue donde lo relacioné con Costa Rica"],
            ['type' => 'paragraph', 'text' => "El artículo sobre el paso del Estado de bienestar hacia la Economía del Bien Común me gustó porque lleva el tema a algo mucho más cercano. Habla de la Caja y de cómo la seguridad social en Costa Rica tiene mucho que ver con esa idea de que ciertos servicios no deberían depender únicamente de cuánto puede pagar una persona, sino que también existe una responsabilidad colectiva."],
            ['type' => 'paragraph', 'text' => "Eso me hizo pensar que el bien común no es simplemente una idea bonita de ayudar a todo el mundo. En realidad también tiene que ver con cómo una sociedad decide organizar sus recursos y qué cosas considera importantes para el bienestar de las personas. Y ahí es donde se vuelve más complicado, porque también aparecen intereses diferentes y no siempre es tan fácil encontrar un equilibrio."],
            ['type' => 'paragraph', 'text' => "Algo que me llamó la atención es que tampoco creo que la solución sea decir que todo tiene que ser público o que todo tiene que ser privado. El artículo habla precisamente de las alianzas entre ambos y de que pueden existir oportunidades, pero también riesgos si no hay reglas claras, transparencia y control."],
            ['type' => 'heading', 'text' => "Me quedó dando vueltas una pregunta"],
            ['type' => 'paragraph', 'text' => "Al final, lo que más me dejó pensando fue cómo se puede saber si realmente estamos generando bienestar y no solamente crecimiento. Porque un negocio puede ganar muchísimo dinero y aun así tener malos efectos en las personas o en el ambiente. Entonces siento que este tema conecta bastante con todo lo que hemos visto anteriormente sobre desarrollo, nuevas economías y emprendimiento social."],
            ['type' => 'paragraph', 'text' => "Creo que eso es lo que más me ha gustado del curso hasta ahora: poco a poco me está haciendo cuestionar cosas que uno normalmente da por hechas. Antes probablemente habría pensado que si algo es rentable y funciona, ya está bien. Ahora siento que también vale la pena preguntarse para quién funciona, qué impacto tiene y qué está dejando detrás."],
            ['type' => 'quote', 'text' => "La pregunta ya no es solo cuánto genera una actividad económica, sino qué genera además de dinero."],
        ],
        'comments' => [],
    ],
    [
        ...
        'title' => '¿Realmente necesitamos comprar tanto?',
        'theme' => 'Economía Circular y Economía Verde',
        'blocks' => [
            ['type' => 'heading', 'text' => "Me puse a pensar en cómo consumimos"],
            ['type' => 'paragraph', 'text' => "La verdad, esta clase me gustó porque siento que es un tema que uno vive todos los días sin darse mucha cuenta. Hablamos de economía circular y economía verde, pero también salió bastante el tema del consumismo, y eso fue lo que más me dejó pensando. Porque uno está tan acostumbrado a comprar cosas, usarlas y después cambiarlas por otras, que casi ni se cuestiona si realmente necesitaba lo nuevo o si simplemente quería tenerlo."],
            ['type' => 'paragraph', 'text' => "Yo siento que muchas veces compramos por costumbre. Sale un teléfono nuevo, una ropa nueva, algo que está de moda y ya uno empieza a pensar que necesita eso aunque lo que tiene todavía funcione perfectamente. Y tampoco creo que esté mal comprar cosas o querer tener cosas buenas, obviamente, pero sí me parece diferente cuando comprar se vuelve más una costumbre que una necesidad."],
            ['type' => 'highlight', 'text' => "El problema no siempre es comprar, sino comprar sin pensar qué estamos consumiendo, cuánto necesitamos y qué pasa después con eso."],
            ['type' => 'heading', 'text' => "Ahí entendí mejor la economía circular"],
            ['type' => 'paragraph', 'text' => "Algo que me ayudó a entender mejor la economía circular fue verla como una forma de tratar de romper ese ciclo de comprar, usar y botar. En lugar de pensar que un producto simplemente termina cuando deja de servir, la idea es buscar formas de reutilizarlo, repararlo, reciclarlo o aprovechar sus materiales para que sigan teniendo algún valor."],
            ['type' => 'paragraph', 'text' => "Me pareció interesante porque siento que muchas veces pensamos en el ambiente solamente desde cosas como no tirar basura o reciclar una botella, pero en realidad también tiene que ver con la forma en que producimos y consumimos desde el principio. Es como preguntarse qué pasa con todo lo que compramos después de que deja de servir."],
            ['type' => 'heading', 'text' => "La parte que más me hizo pensar"],
            ['type' => 'paragraph', 'text' => "También me dejó pensando en que el consumidor tiene cierta responsabilidad, pero tampoco todo depende de nosotros. Una persona puede intentar consumir mejor, pero si las empresas producen de una manera que genera demasiados residuos o hacen productos que duran poco, el problema sigue existiendo. Entonces siento que para que realmente haya un cambio tienen que cambiar varias cosas al mismo tiempo."],
            ['type' => 'paragraph', 'text' => "La presentación de los compañeros también me gustó porque hicieron que el tema se sintiera más cercano y no solamente como otro concepto de economía. Creo que eso ayuda bastante porque cuando uno ve ejemplos reales es más fácil darse cuenta de que estas cosas realmente afectan lo que hacemos todos los días."],
            ['type' => 'heading', 'text' => "Algo que me llevo"],
            ['type' => 'paragraph', 'text' => "Al final, creo que esta clase me dejó una pregunta bastante sencilla: ¿cuántas de las cosas que compramos realmente necesitamos? No siento que haya que dejar de consumir ni nada por el estilo, pero sí creo que estaría bien empezar a pensar un poco más antes de comprar algo, especialmente cuando uno ya tiene algo que funciona."],
            ['type' => 'paragraph', 'text' => "Cada vez veo más que muchos de estos temas del curso están conectados. Primero hablamos de desarrollo, después de nuevas formas de hacer economía y ahora de cómo producimos y consumimos. Y la verdad, me gusta que poco a poco el curso me esté haciendo cuestionar cosas que normalmente uno hace en automático."],
            ['type' => 'quote', 'text' => "A veces consumir mejor empieza simplemente por preguntarse si de verdad necesitamos comprarlo."],
        ],
        'comments' => [],
    ],
    [
        ...
        'title' => 'Emprender es mucho más que tener una buena idea',
        'theme' => 'Introducción al Emprendimiento Social',
        'blocks' => [
            ['type' => 'heading', 'text' => "La idea es apenas el comienzo"],
            ['type' => 'paragraph', 'text' => "La verdad, esta clase me gustó porque siento que ya empezamos a entrar en una parte del curso que me interesaba desde el principio: el emprendimiento social. Uno normalmente escucha \"emprender\" y piensa inmediatamente en tener una idea, hacer un negocio y empezar a vender, pero viendo todo lo de las etapas del emprendimiento me quedó más claro que la idea es literalmente el inicio de todo."],
            ['type' => 'paragraph', 'text' => "En la presentación vimos cómo un emprendimiento va pasando por diferentes etapas, desde la gestación y el inicio hasta el desarrollo y la madurez. Y eso me hizo pensar que tener una buena idea no significa que automáticamente vaya a convertirse en un buen negocio. Hay que desarrollarla, probarla, hacer que funcione y, sobre todo, lograr que pueda mantenerse."],
            ['type' => 'highlight', 'text' => "Una buena idea puede ser el comienzo, pero no necesariamente es un buen emprendimiento."],
            ['type' => 'heading', 'text' => "Entonces, ¿qué cambia cuando hablamos de emprendimiento social?"],
            ['type' => 'paragraph', 'text' => "Lo que más me llamó la atención fue entender que un emprendimiento social tampoco significa simplemente crear una empresa y después donar una parte de las ganancias. La idea es que el problema social o ambiental esté realmente conectado con el negocio y con la solución que se está ofreciendo. En otras palabras, el negocio y el impacto van de la mano."],
            ['type' => 'paragraph', 'text' => "Eso me gustó bastante porque conecta con algo que ya había pensado en las clases anteriores. A mí sí me interesa la idea de emprender, pero no solamente por hacer dinero. También me interesa entender cómo podría existir un proyecto que sea económicamente sostenible y que al mismo tiempo resuelva un problema que realmente afecte a alguien."],
            ['type' => 'heading', 'text' => "También me hizo pensar en la parte que uno no ve"],
            ['type' => 'paragraph', 'text' => "Otra cosa que me pareció interesante fue descubrir que tener una buena idea no es suficiente ni siquiera en el sentido legal. La guía que vimos explica que en Centroamérica existen dificultades porque las leyes no siempre están diseñadas específicamente pensando en los emprendimientos sociales. Entonces un emprendedor puede tener una buena solución, pero igual tiene que pensar en cómo formalizarla, cómo protegerla y cómo hacer que realmente pueda funcionar."],
            ['type' => 'paragraph', 'text' => "También me gustó conocer organizaciones como Yo Emprendedor, porque demuestra que uno no tiene que intentar hacer todo solo. Existen programas, mentorías, capacitación y redes que buscan ayudar a que los emprendimientos puedan crecer y desarrollarse."],
            ['type' => 'paragraph', 'text' => "Al final, creo que esta clase me cambió un poco la idea que tenía de emprender. Antes lo veía más como tener una buena idea y tratar de convertirla en un negocio, pero ahora siento que hay muchas más cosas detrás. Y en el caso del emprendimiento social, todavía hay una pregunta más importante: no solamente si la idea puede funcionar, sino qué problema está resolviendo y qué impacto puede generar."],
            ['type' => 'quote', 'text' => "Una buena idea inicia un emprendimiento; un problema real puede darle un propósito."],
        ],
        'comments' => [],
    ],
    [
